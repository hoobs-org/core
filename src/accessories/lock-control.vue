    ...
    <div id="control">
        <svg width="180" height="180" viewBox="0 0 100 100">
            <g v-if="accessory.values.lock_target_state === 1">
                ...
                <path :fill="`${(client.theme || 'hoobs-light').startsWith('hoobs') ? '#e75a0e' : '#00b9f1'}`" stroke="#ffffff" stroke-miterlimit="10" d="M96.9,77c0,7.1-5.8,12.8-12.8,12.8H16C8.9,89.9,3.1,84.1,3.1,77S8.9,64.2,16,64.2h68C91.1,64.2,96.9,70,96.9,77 z"/>
