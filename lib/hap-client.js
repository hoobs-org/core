...
module.exports = class HapClient {
    ...
    serviceDetails(accessory) {
        const information = accessory.services.find(s => s.type === "0000003E-0000-1000-8000-0026BB765291");
        const results = {};
    ...
    characteristicDetails(accessory, service, name) {
        ...
        for (let i = 0; i < service.characteristics.length; i++) {
            if (service.characteristics[i].type !== "00000023-0000-1000-8000-0026BB765291" && types.characteristics[service.characteristics[i].type]) {
                results.push({
                    aid: accessory.aid,
    ...
    process(accessories) {
        ...
        for (let i = 0; i < accessories.length; i++) {
            ...
            for (let j = 0; j < accessories[i].services.length; j++) {
                if (accessories[i].services[j].type !== "0000003E-0000-1000-8000-0026BB765291" && types.services[accessories[i].services[j].type]) {
                    const name = accessories[i].services[j].characteristics.find(c => c.type === "00000023-0000-1000-8000-0026BB765291") || {
                        iid: 0,
