...
module.exports = class Server {
    ...
    static get paths() {
        ...
        const home = join(OS.userInfo().homedir, ".hoobs");
        ...
        return {
            ...
            homebridge: join(modules, "@hoobs", "hoobs", "lib", "bridge"),
            hap: join(modules, "@hoobs", "hoobs", "node_modules", "hap-nodejs")
        };
    }
    ...
    static reset() {
        if (!HBS.docker) {
            HBS.server.stop().then(() => {
                File.removeSync(Server.paths.application);
