...
module.exports = class Server {
    ...
    static reset() {
        HBS.server.stop().then(() => {
            ...
            if (HBS.docker) {
                HBS.log.info("[Factory Reset] You need to restart this container.");
            } else {
                HBS.log.info("[Factory Reset] Rebooting");
        ...
        if (filename) {
            HBS.server.stop().then(() => {
                ...
                File.createReadStream(filename).pipe(Unzip.Extract({
                    ...
                    if (HBS.docker) {
                        HBS.log.info("[Restore System] You need to restart this container.");
                    } else {
