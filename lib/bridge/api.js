...
API.prototype.publishCameraAccessories = function (pluginName, accessories) {
    ...
    this.emit("publishExternalAccessories", this.seralizeAccessories(accessories));
}
...
API.prototype.registerPlatformAccessories = function (pluginName, platformName, accessories) {
    ...
    this.emit("registerPlatformAccessories", this.seralizeAccessories(accessories));
}

API.prototype.updatePlatformAccessories = function (accessories) {
    this.emit("updatePlatformAccessories", this.seralizeAccessories(accessories));
}
...
API.prototype.unregisterPlatformAccessories = function (pluginName, platformName, accessories) {
    ...
    this.emit("unregisterPlatformAccessories", this.seralizeAccessories(accessories));
}

API.prototype.seralizeAccessories = function (value) {
    const cache = [];
