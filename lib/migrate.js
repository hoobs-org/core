...
module.exports = class Migrate {
    ...
    static layout(path) {
        ...
        for (let i = 0; i < keys.length; i++) {
            ...
            for (let j = 0; j < layout[leys[i]].length; j++) {
                const item = layout[leys[i]][j];
