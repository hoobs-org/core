...
module.exports = class Plugins {
            ...
            if (File.existsSync(filename)) {
                ...
                if (File.existsSync(join(directory, "/platform.schema.json"))) {
                    ...
                    if (data.pluginType === "platform") {
                        schema.platform = JSON.parse(JSON.stringify(data));
                    }
                }
    ...
    static categories() {
        return new Promise((resolve, reject) => {
            const response = global.cache.get("certified-categories");
            ...
            if (response) {
                ...
                Request({
                    ...
                    if (!error) {
                        ...
                        global.cache.set("certified-categories", body, 120);
    ...
    static lookup() {
        return new Promise((resolve, reject) => {
            const response = global.cache.get("certified-plugins");
            ...
            if (response) {
                ...
                Request({
                    ...
                    if (!error) {
                        global.cache.set("certified-plugins", body, 120);
    ...
    static getPlatform(id, name) {
        ...
        switch (method) {
            case "platform_schema":
                ...
                index = config.platforms.findIndex(p => p.platform === alias);
