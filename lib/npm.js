            ...
            process.on("close", () => {
                if (File.existsSync(join(Server.paths.modules.local, `/${name}/package.json`))) {
                    ...
                    if (item.keywords) {
                        ...
                        if (File.existsSync(join(Server.paths.modules.local, `/${name}/platform.schema.json`)) || File.existsSync(join(Server.paths.modules.local, `/${name}/config.schema.json`))) {
                            ...
                            if (plugin.platforms) {
                                ...
                                config.platforms.push(plugin.platforms[0]);
                            }
                        }
                    }
